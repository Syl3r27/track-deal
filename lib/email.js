...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;line-height:1.6;color:#333;max-width:600px;margin:0 auto;padding:20px;">
  ...
  <div style="background:linear-gradient(135deg,#6D28D9 0%,#A78BFA 100%);padding:30px;border-radius:10px 10px 0 0;text-align:center;">
  ...
  <div style="background:#ffffff;padding:30px;border:1px solid #E5E7EB;border-top:none;border-radius:0 0 10px 10px;">
    ...
    <table style="width:100%;margin:20px 0;">
      <tr>
        <td style="padding:10px;background:#F5F3FF;border-radius:4px;">
    ...
    <div style="text-align:center;margin:30px 0;">
      <a href="${product.url}"
         style="display:inline-block;background:#7C3AED;color:#ffffff;padding:14px 30px;text-decoration:none;border-radius:6px;font-weight:600;font-size:16px;">
        View Product →
      </a>
    </div>
    ...
    <div style="border-top:1px solid #E5E7EB;padding-top:20px;margin-top:20px;text-align:center;color:#6B7280;font-size:12px;">
      ...
      <p style="margin-top:10px;">
        <a href="${process.env.NEXT_PUBLIC_APP_URL}" style="color:#7C3AED;text-decoration:none;">
